        ...
        json.forEach((el) => {
          ...
          <div class="product-card">
            ...
            <div>
              ...
              <button class="add-to-cart" data-id="${el.id}" data-product="${el.title},${el.brand},${el.description},${el.price[0]},${el.price[1]},${el.url},${el.stock[0]},${el.stock[1]},${el.id}">Comprar</button>
            </div>
          </div>`;
